...
class MyTestCase(TestCase):
    ...
    def test_affine_n_encode_uppercase2(self):
        self.assertEqual(affine_n_encode("HELLO", 3, 3, 121), "MRHYVS")
    def test_affine_n_encode_uppercase3(self):
        self.assertEqual(affine_n_encode("THEQUICKBROWNFOXJUMPEDOVERTHELAZYDOG", 5, 3, 1721), "KLPWJDVGEZVDSQQWRLMURXSMOEVZMHFLZLQXFWTT")